<?php
foreach ($hibaNama as $key => $value) {
    $fromRelation = $value['relation'];
    $remarks = $value['remarks'];
    $date = $value['hiba_nama_date'];
    $id = $value['h_id'];
}
?>
<!-- /top navigation -->
...
<div class="right_col change_ps_w_ord" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update <small>Hiba Nama</small></h2>
                ...
                if (isset($flash_message)) {
                    if ($flash_message == TRUE) {
                        ...
                        <div class="alert alert-success">
                            ...
                            <strong>Well done!</strong>Hiba nama is updated successfully.
                        </div>
                    <?php } else { ?>
                ...
                <div class="x_content">
                    ...
                    echo form_open_multipart('update_hiba_nama/'.$id, $attributes);
                    ?>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control col-md-7 col-xs-12" name="from_relation" required="required"
                                ...
                                foreach ($relation  as $key=>$val){
                                    ?>
                                    <option value="<?php echo $val;?>"<?php if ($fromRelation == $val) {
                    ...
                    <div class="form-group profile_ed_f_rm" id="remarks">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea id="remarks" name="remarks" placeholder="Hiba nama remark or details description"
                                      class="form-control col-md-7 col-xs-12" ><?php echo $remarks;?></textarea>
                        </div>
                    </div>
                    <div class="form-group profile_ed_f_rm">
