                ...
                if (isset($flash_message)) {
                    if ($flash_message == TRUE) {
                        ...
                        <div class="alert alert-success">
                            ...
                            <strong>Well done!</strong>hearing is added successfully.
                        </div>
                    <?php } else { ?>
                ...
                <div class="x_content">
                    ...
                    ?>
                     ...
                     <div class="form-group profile_ed_f_rm">
		               <label class="control-label col-md-3 col-sm-3 col-xs-12 view_le_nme" for="first-name">Select Case<span class="required"> *</span>
		              </label>
		              <div class="col-md-9 col-sm-9 col-xs-12">
		                  <select class="form-control col-md-7 col-xs-12" name="case_id" required="required" id="cases">
                    ...
                    <div class="form-group profile_ed_f_rm">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12 view_le_nme"
                               for="starting-date">Hearing Date<span class="required"> *</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="date" id="hearing_date" name="hearing_date" placeholder="choose Hearing date"
                    ...
                    <div class="form-group profile_ed_f_rm">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="file" name="case_images[]" multiple required="required" class="form-control col-md-7 col-xs-12" value="" />
                        </div>
                    </div>
